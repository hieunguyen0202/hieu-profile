    ...
    <article class="docs-main">
      ...
      <div class="cert-roadmap">
        <div class="cert-step cert-step--right">
          <div class="cert-step__milestone" data-short="1"><span>Step 01</span>Start</div>
          <div class="cert-step__card is-soon" aria-disabled="true">
            <img class="cert-step__logo" src="../../badges/cncf/kcna.svg" alt="KCNA badge" width="88" height="88">
        ...
        <div class="cert-step cert-step--left">
          <div class="cert-step__milestone" data-short="2"><span>Step 02</span>Admin</div>
          <a class="cert-step__card" href="cka/">
            <img class="cert-step__logo" src="../../badges/cncf/cka.svg" alt="CKA badge" width="88" height="88">
            <div class="cert-step__body">
        ...
        <div class="cert-step cert-step--right">
          <div class="cert-step__milestone" data-short="3"><span>Step 03</span>Developer</div>
          <a class="cert-step__card" href="ckad/">
            <img class="cert-step__logo" src="../../badges/cncf/ckad.svg" alt="CKAD badge" width="88" height="88">
            <div class="cert-step__body">
        ...
        <div class="cert-step cert-step--left">
          <div class="cert-step__milestone" data-short="4"><span>Step 04</span>Security</div>
          <div class="cert-step__card is-soon" aria-disabled="true">
            <img class="cert-step__logo" src="../../badges/cncf/kcsa.svg" alt="KCSA badge" width="88" height="88">
            <div class="cert-step__body">
        ...
        <div class="cert-step cert-step--right">
          <div class="cert-step__milestone" data-short="5"><span>Step 05</span>Specialist</div>
          <a class="cert-step__card" href="cks/">
            <img class="cert-step__logo" src="../../badges/cncf/cks.svg" alt="CKS badge" width="88" height="88">
            <div class="cert-step__body">
