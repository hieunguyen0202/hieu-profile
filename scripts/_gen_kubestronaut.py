...
<body class="docs">
  ...
  <div class="docs-shell docs-shell-single">
    <article class="docs-main">
      ...
      <p class="lede">CKA · CKAD · CKS — exam notes and curriculum from the same track.</p>
      <div class="docs-meta">
        <span><strong>Certs:</strong> 3</span>
        <span><strong>Source:</strong> <a href="https://devsecops.puziol.com.br/en/kubernetes/cka" target="_blank" rel="noopener">Puziol DevSecOps</a></span>
      </div>
